...
public class IdCardUtil {
     ...
     * @return 生日(dd)
     */
    public static Integer getDateByIdCard(String idCard) {
    ...
    public static boolean isValidatedAllIdcard(String idcard) {
        ...
        if (patternIDCard15.matcher(idcard).matches() || patternIDCard18.matcher(idcard).matches()) {
            return false;
        }
    ...
    //连续15位一样的数字
    private final static Pattern patternIDCard15 = Pattern.compile("^([0-9])\\1{14}$");
    //连续18位一样的数字
    private final static Pattern patternIDCard18 = Pattern.compile("^([0-9])\\1{17}$");

    public static void main(String[] args) {
        System.out.println(IdCardUtil.isValidatedAllIdcard("310106198502064059"));
    }
}
