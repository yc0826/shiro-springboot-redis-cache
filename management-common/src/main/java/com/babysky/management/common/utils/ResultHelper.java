...
import com.babysky.management.common.ApiResponse;
import com.babysky.management.common.SystemStatus;
...
public class ResultHelper {
    public final static Logger logger = LogManager.getLogger(ResultHelper.class);
    ...
    public static ApiResponse infoResp(SystemStatus status) {
        ...
        logger.info("Response:" + JSONObject.toJSONString(apiResponse));
        return apiResponse;
    }
