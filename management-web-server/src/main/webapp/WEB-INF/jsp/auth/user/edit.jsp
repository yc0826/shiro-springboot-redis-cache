            ...
            <form class="layui-form">
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mstInterUserDtlEntity.userLastName" autocomplete="off"
                                   class="layui-input" placeholder="请输入姓" value="${userDtl.userLastName}"
                                   lay-verify="notnull" maxlength="16">
                        </div>
                    </div>
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="mstInterUserDtlEntity.userFirstName"
                                   autocomplete="off"
                                   class="layui-input" placeholder="请输入名字" value="${userDtl.userFirstName}"
                                   lay-verify="notnull" maxlength="16">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="userName"
                                   placeholder="请输入用户名" class="layui-input" value="${user.userName}"
                                   lay-verify="notnull"
                                   autocomplete="off"/>
                        </div>
                    </div>
                    <div class=" layui-col-md6">
                        ...
                        <div class="layui-input-inline">
                            <input id="mobNum" type="text" required name="mobNum"
                                   placeholder="请输入手机号" class="layui-input" value="${user.mobNum}"
                ...
                <div class="layui-form-item layui-row">
                    <div class="layui-col-md6">
                            ...
                            <div class=" layui-col-md12">
                                ...
                                <div class="layui-input-inline">
                                    <input type="radio" name="mstInterUserDtlEntity.gderFlg" value="1" title="男"
                                           <c:if test="${userDtl.gderFlg}">checked</c:if> >
                        ...
                        <div class=" layui-form-item layui-row">
                            <div class=" layui-col-md12">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" value="${userDtl.birthday}" name="mstInterUserDtlEntity.birthday"
                                           id="birthday"
                    ...
                    <div class="layui-col-md6">
                        ...
                        <input type="hidden" id="avtrImgCode" name="avtrImgCode">
