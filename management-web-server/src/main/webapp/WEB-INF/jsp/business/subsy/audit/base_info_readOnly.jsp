        ...
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item layui-row">
                <div class=" layui-col-md6">
                    <label class="layui-form-label label-style">会所入驻日期</label>
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input"
                               name="subsyActivStartTimeDisplay" value="${auditInfo.mstSubsyBaseEntity.subsyActivStartTimeDisplay}" placeholder="会所入驻日期"  readonly/>
                    </div>
                </div>
                <div class=" layui-col-md6">
                    <label class="layui-form-label label-style">会所有效期</label>
                    <div class="layui-input-inline">
                        <input type="text" class="layui-input" autocomplete="false" lay-verify="required"
                               id="subsyActivYears" name="subsyActivYears" value="${auditInfo.mstSubsyBaseEntity.subsyActivYears}" placeholder="会所有效期"  readonly/>
                    </div>
                </div>
            </div>
