...
<div class="row mt wrapper">
    <div class=" layui-row row-style">
        <div class="col_main lightshadow form-panel">
            <h2 class="page_headline"><span class="c_blue store_title">编辑房型</span></h2>
            <div class="pb50">
                <!-- 表格开始 -->
                <form class="layui-form">
                    ...
                    <div class="add_store">
                        <ol class="add_store_ol" style="list-style: none;">
                            ...
                            <li class="add_store_li form-group-box">
                                <label class="add_store_span col-sm-2  control-label label-span">房间名称</label>
                                <div class="col-sm-8">
                                    <input id="roomTypeName" type="text" required name="roomTypeName"
                                           value="${entity.roomTypeName}"
                                           placeholder="输入房间名称" class="add_store_inp form-control"
                                           autocomplete="false"/>
                                </div>
                            </li>
                            <li class="add_store_li form-group-box">
                                <label class="add_store_span col-sm-2  control-label label-span">房间面积</label>
                                <div class="col-sm-8">
                                    <input id="roomTypeArea" type="text" required name="roomTypeArea"
                                           value="${entity.roomTypeArea}"
                                           placeholder="输入房间面积" class="add_store_inp form-control"
                                           autocomplete="false"/>
                                </div>
                            </li>
                            <li class="add_store_li form-group-box">
                                <label class="add_store_span col-sm-2  control-label label-span">房间金额</label>
                                <div class="col-sm-8">
                                    <input id="roomTypeAmt" type="text" required name="roomTypeAmt"
                                           value="${entity.roomTypeAmt}"
                                           placeholder="输入房间金额" class="add_store_inp form-control"
                                           autocomplete="false"/>
                                </div>
                            </li>
                            <li class="add_store_li form-group-box">
                                ...
                                <div class="col-sm-8">
                                    <input id="roomTypeDesc" type="text" required name="roomTypeDesc"
                                           value="${entity.roomTypeDesc}"
                            ...
                            <li class="add_store_li form-group-box">
                                ...
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
                                        <div class="col-sm-8">
                                            <button class="layui-btn" lay-submit lay-filter="roomTypeCode">${op}</button>
...
<script>
    ...
    layui.use(['layer', 'globalAjax', 'ztree', 'form'], function () {
        ...
        //监听提交
        form.on('submit(roomTypeCode)', function (data) {
            $.ajax({
                ...
                success: function (data) {
                    if(data.status === 200) {
                        layer.alert("${op}房型成功",{closeBtn: 0},  function () {
                            window.location.href = "${ctx}/room/roomTypeList";
                        })
                    } else {
