            ...
            <div class="layui-form-item layui-row">
                <div class="layui-col-md12">
                    <table class="layui-table">
                        ...
                        <tbody id="zengzhifuwu_content">
                        <c:set var="zengzhifuwucount" value="0"></c:set>
                        <c:forEach items="${auditInfo.mstOrderProdEntityList}" var="orderProd" varStatus="vs">
                            <c:if test="${orderProd.prodTypeCode == '00110006'}">
                                <tr>
                                    <td>${zengzhifuwucount = zengzhifuwucount + 1}</td>
                                    <td>
