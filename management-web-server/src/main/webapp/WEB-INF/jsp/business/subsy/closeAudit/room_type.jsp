...
<div class="layui-tab-item">
    <div class="col_main lightshadow form-panel layui-col-md12">
        <c:if test="${(auditInfo.isAllowEditProduct != null && auditInfo.isAllowEditProduct == 1) }">
            ...
            <form class="layui-form" action="" id="roomTypeForm">
                <input type="hidden" name="subsyCode" class="subsyCode" value="${auditInfo.subsyCode}">
                <input type="hidden" name="prodTypeCode" value="00110001"/>
                <div class="layui-form-item layui-row">
                    <div class=" layui-col-md6">
                        <label class="layui-form-label label-style">房间名称</label>
                        <div class="layui-input-inline">
                            <input type="text" name="prodName" placeholder="请输入房间名称" lay-verify="notnull"
                                   autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                ...
                <div class="layui-form-item layui-row">
                    <div class="layui-col-md6">
                        <label class="layui-form-label label-style">面积</label>
                        <div class="layui-input-inline">
                            <input type="text" name="roomTypeArea" autocomplete="off"
                                   class="layui-input" placeholder="请输入房型面积" lay-verify="notnull"
                                   maxlength="32">
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-row">
                    <div class=" layui-col-md12">
                        <label class="layui-form-label label-style">产品描述</label>
                        <div class="layui-input-inline">
        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item layui-row">
                <div class="layui-col-md12">
                    <table class="layui-table">
                        ...
                        <tbody id="roomType_content">
                        <c:set var="roomcount" value="0"></c:set>
                        <c:forEach items="${auditInfo.mstOrderProdEntityList}" var="orderProd" varStatus="vs">
                            <c:if test="${orderProd.prodTypeCode == '00110001'}">
                                <tr>
                                    <td>${roomcount = roomcount + 1}</td>
                                    <td>
                                        ...
                                        <input type="hidden"
                                               name="mstOrderProdEntityList[${vs.index}].roomTypeArea"
                                               class="roomTypeArea_${vs.index}"
                                               value="${orderProd.roomTypeArea}"/>
                                        <input type="hidden"
                                    ...
                                    <td>
                                        <span class="prodAmt_span_${vs.index}">${orderProd.prodAmtDisplay}</span>
                                        <input type="hidden"
            ...
            <c:if test="${(auditInfo.isAllowEditProduct != null && auditInfo.isAllowEditProduct == 1) }">
                <div class="layui-form-item btn-position">
                    ...
                    <%--</div>--%>
                    <%--<div class="layui-inline">--%>
                        <%--<button class="layui-btn layui-btn-primary next-step" lay-submit lay-filter="roomTypeNextBtn">下一步room--%>
                        <%--</button>--%>
                    <%--</div>--%>
        ...
        <table class="layui-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="hidden"
                           name="mstOrderProdEntityList[$$ROWNUM$$].roomTypeArea"
                           class="roomTypeArea_$$ROWNUM$$"/>
                    <input type="hidden"
