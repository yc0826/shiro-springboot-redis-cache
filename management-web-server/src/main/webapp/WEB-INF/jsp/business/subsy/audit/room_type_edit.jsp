...
<body>
    <div class="col_main lightshadow form-panel layui-col-md12">
        ...
        <form class="layui-form" action="" id="roomTypeForm" lay-filter="roomTypeForm">
                ...
                <div class="layui-form-item layui-row">
                    <div class=" layui-col-md12">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="prodName" placeholder="请输入房间名称" lay-verify="notnull" autocomplete="off" value="${mstOrderProdEntity.prodName}" class="layui-input" <c:if test="${pageMode!=null && pageMode=='readonly'}">readonly</c:if> >
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-row">
                    <div class=" layui-col-md12">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="roomTypeArea" autocomplete="off"
                                   ...
                                   maxlength="32" value="${mstOrderProdEntity.roomTypeArea}" <c:if test="${pageMode!=null && pageMode=='readonly'}">readonly</c:if> >
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-row">
