...
<div class="layui-tab-item">
    <div class="col_main lightshadow form-panel layui-col-md12">
        <c:if test="${(auditInfo.isAllowEditProduct != null && auditInfo.isAllowEditProduct == 1) }">
            ...
            <form class="layui-form" action="" id="chanhouxiufuForm">
            ...
            <div class="layui-form-item layui-row">
                <div class="layui-col-md12">
                    <table class="layui-table">
                        ...
                        <tbody id="chanhouxiufu_content">
                        <c:set var="chanhouxiufucount" value="0"></c:set>
                        <c:forEach items="${auditInfo.mstOrderProdEntityList}" var="orderProd" varStatus="vs">
                            <c:if test="${orderProd.prodTypeCode == '00110007'}">
                                <tr>
                                    <td>${chanhouxiufucount = chanhouxiufucount + 1}</td>
                                    <td>
