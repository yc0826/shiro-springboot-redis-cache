...
<body>
    <div class="col_main lightshadow form-panel layui-col-md12">
        ...
        <form class="layui-form" action="" id="muyingchanpinForm" lay-filter="muyingchanpinForm">
                ...
                <div class="layui-form-item layui-row">
                    <div class=" layui-col-md12">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="prodName" placeholder="请输入产品名称" lay-verify="notnull" autocomplete="off" value="${mstOrderProdEntity.prodName}" class="layui-input" <c:if test="${pageMode!=null && pageMode=='readonly'}">readonly</c:if> >
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-row">
