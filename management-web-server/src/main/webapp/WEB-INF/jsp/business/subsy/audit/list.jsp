                ...
                <form class="layui-form">
                    <div class="layui-form-item layui-row">
                        ...
                        <div class="layui-inline layui-col-md3">
                            ...
                            <c:if test="${isAllowAddSubsy != null && isAllowAddSubsy == 1}">
                        ...
                        <div class="content-panel">
                            <table id="table_data" class="dataTable table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 5%;">产品状态</th>
                                    <th style="width: 5%;">会所关闭状态</th>
                                    <th style="width: 5%;">最后更新时间</th>
...
<script>
    ...
    layui.use(['element', 'layer', 'globalAjax', 'datatable', 'jquery', 'jqueryui', 'form'], function () {
        ...
        form.on('submit(add)', function () {
            window.location.href = "${ctx}/subsyAudit/create";
            return false;
        });
        //初始化表格
        function initTable(brandCode, statCode) {
            ...
            json = {};
            json.id = "table_data";
            json.url = '${ctx}/subsyAudit/getSubsyListData';
            json.param = [{
                name: "name",
                value: $("#name").val()
            }, {
            ...
            json.columns = [
                ...
                {
                    "mData": "mstSubsyBaseEntity.subsyCode",
                    "sWidth": "180px",
                    "sClass": "text-center"
                }, {
                    ...
                    "mData": "mstSubsyBaseEntity.cityName",
                    "sWidth": "200px",
                    "sClass": "text-center"
                }, {
                    ...
                    "mData": "mstSubsyBaseEntity.auditStatusName",
                    "sWidth": "100px",
                    "sClass": "text-center"
                }, {
                    "mData": "mstSubsyBaseEntity.prodAuditStatusName",
                    "sWidth": "100px",
                    "sClass": "text-center"
                }, {
                    ...
                    "mRender": function (data, type, row) {
                        console.log("isAllowEditProduct="+row.isAllowEditProduct +"  isAllowAuditProduct="+row.isAllowAuditProduct +"  isAllowAuditSubsy="+row.isAllowAuditSubsy +"  isAllowEditSubsy="+row.isAllowEditSubsy);

                        if (row.createTime) {
                            return longToDateTime(row.updateTime);
                        } else {
                            return longToDateTime(row.updateTime);
                        }
                    }
        ...
        $(document).on('click', ".toDetail", function () {
            var id = $(this).attr("vb");
            window.location.href = "${ctx}/subsyAudit/" + id + "/toEdit"
        });

        $(document).on('click', ".toDetailWithReadOnly", function () {
            var id = $(this).attr("vb");
            window.location.href = "${ctx}/subsyAudit/" + id + "/toDetailWithReadOnly"
        });
