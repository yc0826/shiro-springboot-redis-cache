...
<head>
    ...
    <title>会所房型管理</title>
    <shiro:hasPermission name="roomType:update">
        <c:set value="1" var="allow_update"/>
    </shiro:hasPermission>
    <shiro:hasPermission name="roomType:delete">
    ...
    <div class="layui-body">
                ...
                <div class="form-panel">
                    <div class="panel-heading">
                        <h5 class="mb"><i class="fa fa-list-ul"></i>会所房型管理</h5>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <label class="col-xs-3  control-label">房间名称</label>
                                            <div class="col-xs-9">
                                                <input class="form-control" id="roomTypeName" type="text"/>
                                            </div>
                                ...
                                <div class="content-panel">
                                    <table id="table_data" class="dataTable table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 10%;">房间面积</th>
                                            <th style="width: 10%;">房间金额</th>
                                            <th style="width: 20%;">房间描述</th>
...
<script>
    ...
    layui.use(['element', 'layer', 'globalAjax', 'datatable', 'jquery', 'form'], function () {
        ...
        function initTable() {
            ...
            json = {};
            json.id = "table_data";
            json.url = '${ctx}/room/getRoomTypeList';
            json.param = [
                {
                    "name": "roomTypeName",
                    "value": $("#roomTypeName").val()
                }
            ...
            json.columns = [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        array.push("<button class=\"layui-btn layui-btn-primary layui-btn-sm toEdit\" vb=\"" + row.roomTypeCode + "\">");
                        array.push("<i class=\"layui-icon\">&#xe642;</i>");
                        array.push("</button>")
                        </c:if>
                        <c:if test="${allow_delete==1}">
                        array.push("<button class=\"layui-btn layui-btn-primary layui-btn-sm deleteRoomType\" vb=\"" + row.roomTypeCode + "\">");
                        array.push("<i class=\"layui-icon\">&#xe640;</i>");
                        array.push("</button>")
                        </c:if>
                        array.push("</div>");
        ...
        $("#add").click(function () {
            window.location.href = "${ctx}/room/createRoomType"
        })

        $(document).on('click', ".toEdit", function () {
            var roomTypeCode = $(this).attr("vb");
            window.location.href = "${ctx}/room/" + roomTypeCode + "/updateRoomType"
        });
        $(document).on('click', ".deleteRoomType", function () {
            var roomTypeCode = $(this).attr("vb");
            layer.confirm('是否删除？', {icon: 3, title: '提示'}, function (index) {
                    $.ajax({
                        url: "${ctx}/room/" + roomTypeCode + "/roomTypeDelete",
                        type: "POST",
                        dataType : "json",
