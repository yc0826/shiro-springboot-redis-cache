...
<body>
    <div class="col_main lightshadow form-panel layui-col-md12">
        ...
        <form class="layui-form" action="" id="yuezicanForm" lay-filter="yuezicanForm">
                ...
                <div class="layui-form-item layui-row">
                    <div class=" layui-col-md12">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="prodName" placeholder="请输入餐品名称" lay-verify="notnull" autocomplete="off" value="${mstOrderProdEntity.prodName}" class="layui-input" <c:if test="${pageMode!=null && pageMode=='readonly'}">readonly</c:if> >
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-row">
