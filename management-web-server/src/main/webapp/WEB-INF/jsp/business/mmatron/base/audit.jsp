        ...
        <div class="form-panel">
            ...
            <form class="layui-form">
                ...
                <shiro:hasPermission name="mmatron:audit">
                    <c:if test="${mmatron.mmatronBaseCode != null}">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                            <textarea id="remark" name="tranMmatronAuditEntity.remark" lay-verify="notnull"
                                      placeholder="请输入内容"
                ...
                <div class="layui-form-item btn-position">
                    ...
                    <c:if test="${mmatron.mmatronBaseCode != null}">
                        <div class="layui-inline">
                            <button class="layui-btn layui-btn-normal layui-bg-red" lay-submit lay-filter="disAgree">
                                不同意
                            </button>
                        </div>
                    </c:if>
                    <c:if test="${mmatron.mmatronBaseCode != null}">
                        <div class="layui-inline">
                            <button type="button" class="layui-btn layui-btn-normal" id="agree">同意</button>
                        </div>
                    </c:if>
                </div>
            </form>
...
<script>
    ...
    layui.use(['layer', 'globalAjax', 'form', 'verify', 'laydate', 'upload'], function () {
        ...
        $("#agree").on("click", function () {
            $.ajax({
                url: "${ctx}/mmatron/agreeAudit",
                type: 'post',
                data: {
                    mmatronBaseCode: '${mmatron.mmatronBaseCode}',
                    remark: $("#remark").val()
                },
                dataType: 'json',
                timeout: 10000,
