    ...
    <div class="layui-body">
        <div class="form-panel">
            <div class="panel-heading">
                <h5 class="mb"><i class="fa fa-list-ul"></i>住家护理师管理费明细</h5>
            </div>
                        ...
                        <div class="content-panel">
                            <table id="table_data" class="dataTable table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 10%;">住家护理师销售收入</th>
                                    <th style="width: 10%;">管理费（元）</th>
                                </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
<script>
    ...
    layui.use(['element', 'layer', 'globalAjax', 'datatable', 'laydate', 'jquery', 'form'], function () {
        ...
        function initTable(startDate, endDate, subsyCode, mmatronName) {
            ...
            json = {};
            json.id = "table_data";
            json.url = '${ctx}/mmatronReport/mmatronManagementCostDataList';
            json.param = [{
                name: "startDate",
                value: startDate
            }, {
            ...
            json.columns = [
                {
                    ...
                    "mData": "totalServicePrice",
                    "sWidth": "200px",
                    "sClass": "text-center"
                }, {
                    "mData": "managementCost",
                    "sWidth": "200px",
                    "sClass": "text-center"
                }
            ];
