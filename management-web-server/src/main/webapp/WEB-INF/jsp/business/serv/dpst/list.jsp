    ...
    <div class="layui-body">
        ...
        <div class="form-panel">
            <div class="panel-heading">
                <h5 class="mb"><i class="fa fa-list-ul"></i>押金管理</h5>
            </div>
...
<script>
    ...
    layui.use(['element', 'layer', 'globalAjax', 'datatable', 'jquery', 'jqueryui', 'form'], function () {
        ...
        function initTable() {
            ...
            json = {};
            json.id = "table_data";
            json.url = '${ctx}/dpst/querydpstData';
            json.param = [
                {
                    "name": "userName",
                    "value": $("#userName").val()
            ...
            json.columns = [
                ...
                },
                {
                    ...
                    "mRender": function (data, type, row) {
                        ...
                        array.push("<button class=\"layui-btn layui-btn-primary layui-btn-sm toDetail\" vb=\"" + row.exterUserCode +  "%7C" + row.subsyCode  + "\">");
        ...
        $(document).on('click', ".toDetail", function () {
            var dpst = $(this).attr("vb");
            // alert(dpst);
            window.location.href = "${ctx}/dpst/" + dpst + "/detail";
        });
    });
