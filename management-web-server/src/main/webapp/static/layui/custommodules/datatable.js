layui.define(['jquery'], function (exports) {
            ...
            var j = function (e) {
                ...
                function ua(a) {
                    ...
                    for (i = a.aoColumns.length; c < i; c++) {
                        ...
                        var w = e._bAutoType, o = "function" === typeof e.fnRender, k = null !== e.sClass,
                            n = e.bVisible, m, p;
                        if (w || o || k || !n) {
                            g = 0;
                ...
                function ja(a, b) {
                    var c = a.fnFormatNumber(a._iDisplayStart + 1), d = a.fnDisplayEnd(), d = a.fnFormatNumber(d),
                        i = a.fnRecordsDisplay(), i = a.fnFormatNumber(i), f = a.fnRecordsTotal(),
                ...
                function La(a) {
                    var b = a.nScrollHead.getElementsByTagName("div")[0], c = b.getElementsByTagName("table")[0],
                        ...
                        r = a.oBrowser.bScrollOversize, s = function (a) {
                            k =
                                a.style;
                            k.paddingTop = "0";
                            k.paddingBottom = "0";
                ...
                this.oApi = {
                    ...
                    _fnCreateCookie: function (a, b, c, d, e) {
                        ...
                        var c = X.location.pathname.split("/"),
                            a = a + "_" + c.pop().replace(/[\/:]/g, "").toLowerCase(), g;
        ...
        tableManaged: function (param) {
            return {
                ...
                init: function () {
                    ...
                    return $('#' + json.id).dataTable({
                        "bFilter": false,
                        "bSort": false,
                        "bProcessing": false,
                        "sAjaxSource": json.url,
                        "fnServerParams": function (aoData) {
                            $.each(json.param, function (i, item) {
                                aoData.push(item);
                            });
                        },
                        "sServerMethod": "post",
                        "bServerSide": true,
                        "aoColumns": json.columns ? json.columns : null,
                        //"aLengthMenu" : [ [ 10, 20, 50 ], [ 10, 20, 50 ] ],
                        "iDisplayLength": 10,
                        "bLengthChange": false,
                        "sPaginationType": "full_numbers",
                        "aaSorting": json.aaSorting ? json.aaSorting : '',
                        "aoColumnDefs": [{
                            "sDefaultContent": '',
                            "aTargets": ["_all"]
                        }],

                        "fnCreatedRow": function (nTr, data, iRow, iTotal) {
                            if (nTr) {
                                nTr.cells[0].innerHTML = (iRow + 1);
                            }
                        },
                        ...
                        "oLanguage": json.pageInfo ? json.pageINfo : {
    ...
    exports('datatable', obj); //注意，这里是模块输出的核心，模块名必须和use时的模块名一致
});